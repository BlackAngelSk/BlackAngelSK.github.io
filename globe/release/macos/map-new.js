...
function setTool(tool) {
    ...
    /* UI */
    $$('.top-tool-btn').forEach(b => b.classList.toggle('active', b.dataset.tool === tool));
...
function applyVisibility() {
    ...
    const topBar = $('#top-bar'), sidebar = $('#sidebar');
    ...
    /* New UI: toggle top bar and sidebar */
    if (topBar) topBar.style.display = $('#cfg-show-toolbar').checked  ? '' : 'none';
    if (sidebar) sidebar.style.display = $('#cfg-show-bottombar').checked ? '' : 'none';
}
